...
volunteer_activism
          ...
          <div className="w-full flex lg:gap-0 gap-6 justify-evenly lg:flex-nowrap flex-wrap">
            <div className="lg:h-[65vh] md:h-[95vh] h-[110vh] w-[340px] items-center scroll-animate change text-greenC rounded-3xl border bg-amber-100  shadow-md shadow-amber-100 flex flex-col gap-4 justify-center p-5">
