    ...
    return(
        ...
        <div className="lg:h-[70vh] h-fit w-full flex gap-12 lg:flex-nowrap flex-wrap justify-evenly items-center ">
          <div className="lg:h-[70vh] md:h-[50vh] h-[50vh] w-[340px] bg-amber-100 change rounded-2xl flex gap-3 scroll-animate text-greenC flex-col justify-center items-center py-3 p-7">
            <div  class="w-full lg:h-[120px] md:h-[140px] h-[130px] rounded-2xl bg-no-repeat bg-cover bg-[url(../poblic/img/causes-img-1.jpg)] "></div>
          ...
          <div className="lg:h-[70vh] md:h-[50vh] h-[50vh] w-[340px] bg-amber-100 change rounded-2xl flex gap-3 scroll-animate text-greenC flex-col justify-center items-center py-3 p-7">
            <div  class="w-full lg:h-[120px] md:h-[140px] h-[130px] rounded-2xl bg-no-repeat bg-cover bg-[url(../poblic/img/causes-img-2.jpg)] "></div>
          ...
          <div className="lg:h-[70vh] md:h-[50vh] h-[50vh] w-[340px] bg-amber-100 change rounded-2xl flex gap-3 scroll-animate text-greenC flex-col justify-center items-center py-3 p-7">
            <div  class="w-full lg:h-[120px] md:h-[140px] h-[130px] rounded-2xl bg-no-repeat bg-cover bg-[url(../poblic/img/causes-img-3.jpg)] "></div>
