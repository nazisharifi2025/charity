export default function Gallery(){
    return(
          <div className="lg:h-screen md:h-[180vh] h-[340vh] mb-12 w-full flex flex-col scroll-animate gap-3 justify-center items-center">
...
volunteer_activism
        ...
        <div className="lg:h-[80%] md:h-[100vh] h-full lg:w-[90%] w-full grid scroll-animate lg:grid-cols-5 lg:grid-rows-2 md:grid-cols-5 md:grid-rows-2 grid-cols-3 grid-rows-4">
